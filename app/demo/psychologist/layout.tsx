...
const navItems = [
    { href: '/demo/psychologist', label: 'Dashboard', emoji: '🩺' },
    { href: '/demo/psychologist/sessions', label: 'Sessions', emoji: '📅' },
]
                    ...
                    {navItems.map(item => {
                        ...
                        return (
                            <Link key={item.href} href={item.href} style={{
                                ...
                                fontWeight: active ? 500 : 400, fontSize: 'var(--text-sm)', textDecoration: 'none',
