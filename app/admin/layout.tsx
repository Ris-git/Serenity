            ...
            <aside className="sidebar">
                ...
                <nav style={{ flex: 1, padding: '0 12px' }}>
                    <Link href="/admin" style={{
                        ...
                        background: pathname === '/admin' ? 'var(--color-sage-10)' : 'transparent',
                        border: pathname === '/admin' ? '1px solid var(--color-sage-15)' : '1px solid transparent',
                        color: pathname === '/admin' ? 'var(--color-sage-dark)' : 'var(--color-charcoal)',
