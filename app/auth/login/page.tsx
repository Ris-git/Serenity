        ...
        <div style={{
            ...
            <div style={{
                        ...
                        {demoAccounts.map(account => (
                            <Link
                                ...
                                style={{
                                    ...
                                    gap: '12px',
                                    padding: '12px 16px',
                                    background: demoRole === account.role ? 'var(--color-sage-8)' : 'var(--color-cream-dark)',
                                    border: `1.5px solid ${demoRole === account.role ? 'var(--color-sage)' : 'var(--color-charcoal-6)'}`,
                                ...
                                onMouseEnter={e => {
                                    (e.currentTarget as HTMLElement).style.background = 'var(--color-sage-8)'
                                        ; (e.currentTarget as HTMLElement).style.borderColor = 'var(--color-sage)'
                                }}
                                onMouseLeave={e => {
                                    (e.currentTarget as HTMLElement).style.background = 'var(--color-cream-dark)'
                                        ; (e.currentTarget as HTMLElement).style.borderColor = 'var(--color-charcoal-6)'
                                }}
                            >
                ...
                <p style={{ textAlign: 'center', marginTop: '32px', fontSize: 'var(--text-sm)', color: 'var(--color-soft-gray)' }}>
                    New student?{' '}
                    <Link href="/auth/register" style={{ color: 'var(--color-sage-dark)', fontWeight: 500 }}>
                        Create account
                    </Link>
                </p>
            </div>
